...
func (pvu *PlaylistVideoUpdate) SetUserID(id int) *PlaylistVideoUpdate {
	pvu.mutation.SetUserID(id)
	return pvu
}

// SetNillableUserID sets the user edge to User by id if the given value is not nil.
func (pvu *PlaylistVideoUpdate) SetNillableUserID(id *int) *PlaylistVideoUpdate {
	if id != nil {
...
func (pvu *PlaylistVideoUpdate) SetUser(u *User) *PlaylistVideoUpdate {
...
func (pvu *PlaylistVideoUpdate) ClearUser() *PlaylistVideoUpdate {
...
func (pvu *PlaylistVideoUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if pvu.mutation.UserCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   playlist_video.UserTable,
			Columns: []string{playlist_video.UserColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: &sqlgraph.FieldSpec{
					Type:   field.TypeInt,
...
// SetUserID sets the user edge to User by id.
func (pvuo *PlaylistVideoUpdateOne) SetUserID(id int) *PlaylistVideoUpdateOne {
	pvuo.mutation.SetUserID(id)
	return pvuo
}

// SetNillableUserID sets the user edge to User by id if the given value is not nil.
func (pvuo *PlaylistVideoUpdateOne) SetNillableUserID(id *int) *PlaylistVideoUpdateOne {
	if id != nil {
...
// SetUser sets the user edge to User.
func (pvuo *PlaylistVideoUpdateOne) SetUser(u *User) *PlaylistVideoUpdateOne {
...
// ClearUser clears the user edge to User.
func (pvuo *PlaylistVideoUpdateOne) ClearUser() *PlaylistVideoUpdateOne {
