...
func (pvq *PlaylistVideoQuery) QueryUser() *UserQuery {
...
func (pvq *PlaylistVideoQuery) WithUser(opts ...func(*UserQuery)) *PlaylistVideoQuery {
	query := &UserQuery{config: pvq.config}
	for _, opt := range opts {
		opt(query)
	}
...
func (pvq *PlaylistVideoQuery) sqlAll(ctx context.Context) ([]*Playlist_Video, error) {
	...
	if pvq.withPlaylist != nil || pvq.withVideo != nil || pvq.withResolution != nil || pvq.withUser != nil {
		withFKs = true
	}
	if withFKs {
