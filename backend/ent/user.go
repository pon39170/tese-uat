...
// was not loaded in eager-loading.
func (e UserEdges) PlaylistVideosOrErr() ([]*Playlist_Video, error) {
	if e.loadedTypes[2] {
...
// QueryPlaylistVideos queries the playlist_videos edge of the User.
func (u *User) QueryPlaylistVideos() *PlaylistVideoQuery {
	return (&UserClient{config: u.config}).QueryPlaylistVideos(u)
}
