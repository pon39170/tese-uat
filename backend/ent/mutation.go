...
func (m *PlaylistVideoMutation) SetUserID(id int) {
	m.user = &id
}

// ClearUser clears the user edge to User.
func (m *PlaylistVideoMutation) ClearUser() {
	m.cleareduser = true
}

// UserCleared returns if the edge user was cleared.
func (m *PlaylistVideoMutation) UserCleared() bool {
	return m.cleareduser
}

// UserID returns the user id in the mutation.
func (m *PlaylistVideoMutation) UserID() (id int, exists bool) {
	if m.user != nil {
		return *m.user, true
	}
	return
...
func (m *PlaylistVideoMutation) UserIDs() (ids []int) {
	if id := m.user; id != nil {
		ids = append(ids, *id)
	}
	return
...
func (m *PlaylistVideoMutation) ResetUser() {
	m.user = nil
	m.cleareduser = false
}
...
func (m *PlaylistVideoMutation) AddedEdges() []string {
	...
	if m.user != nil {
		edges = append(edges, playlist_video.EdgeUser)
	}
	return edges
}
...
// AddPlaylistVideoIDs adds the playlist_videos edge to Playlist_Video by ids.
func (m *UserMutation) AddPlaylistVideoIDs(ids ...int) {
	if m.playlist_videos == nil {
		m.playlist_videos = make(map[int]struct{})
	}
	for i := range ids {
...
// RemovePlaylistVideoIDs removes the playlist_videos edge to Playlist_Video by ids.
func (m *UserMutation) RemovePlaylistVideoIDs(ids ...int) {
	if m.removedplaylist_videos == nil {
		m.removedplaylist_videos = make(map[int]struct{})
	}
	for i := range ids {
...
// RemovedPlaylistVideos returns the removed ids of playlist_videos.
func (m *UserMutation) RemovedPlaylistVideosIDs() (ids []int) {
	for id := range m.removedplaylist_videos {
		ids = append(ids, id)
	}
	return
...
// PlaylistVideosIDs returns the playlist_videos ids in the mutation.
func (m *UserMutation) PlaylistVideosIDs() (ids []int) {
	for id := range m.playlist_videos {
		ids = append(ids, id)
	}
	return
...
// ResetPlaylistVideos reset all changes of the "playlist_videos" edge.
func (m *UserMutation) ResetPlaylistVideos() {
	m.playlist_videos = nil
	m.removedplaylist_videos = nil
}
...
func (m *UserMutation) AddedEdges() []string {
	...
	if m.playlist_videos != nil {
		edges = append(edges, user.EdgePlaylistVideos)
	}
	return edges
}
