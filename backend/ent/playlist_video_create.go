...
func (pvc *PlaylistVideoCreate) SetUserID(id int) *PlaylistVideoCreate {
	pvc.mutation.SetUserID(id)
	return pvc
}

// SetNillableUserID sets the user edge to User by id if the given value is not nil.
func (pvc *PlaylistVideoCreate) SetNillableUserID(id *int) *PlaylistVideoCreate {
	if id != nil {
...
func (pvc *PlaylistVideoCreate) SetUser(u *User) *PlaylistVideoCreate {
